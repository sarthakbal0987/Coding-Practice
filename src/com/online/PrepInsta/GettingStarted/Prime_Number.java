...
public class Prime_Number {
    public static void main(String[] args) {
        ...
        if (number<=0)
        {
            if (number == 0) System.out.println("Zero is neither prime nor composite😊");
            else System.out.println("Negative integers can not be prime!🚫");
        }else{
    ...
    public static boolean checkPrime(int n){
        ...
        /*
        * Iteration will continue till half of the number bcz after half of the number no number can
