...
public class Reverse_Number {
    public static void main(String[] args) {
        ...
        //Calling reverseTheNumber() which will return reverse number of the entered number
...
* ---------------------------------
* Declaring and initializing the rev variable in which the reverse form of the number will be store
*
* rev = 0;
*
* number = 123(suppose)
