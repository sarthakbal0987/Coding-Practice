...
public class Sum_Of_Numbers_GivenRange {
    public static void main(String[] args) {
        ...
        sumOfNumbers(n,N); //Calling the sumOfNumbers() method and passed the first range and second range as parameter.
    }
    static void sumOfNumbers(int range,int range1){
        ...
        for (int i = range; i <= range1; i++) {
            ...
            if (i == range1 ) { //It will check which is last number.Here range1 is last number, so it will print '=' instead of '+'symbol.
